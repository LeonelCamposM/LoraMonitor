...
#     db.collection("users/yuY2SQJgcOYgPUKvUdRx/dashboard").document("lastMeasure").collection("values").document(sensor).set(sensor_data)
...
#     db.collection("users/yuY2SQJgcOYgPUKvUdRx/dashboard").document("userLimits").collection("values").document(limit).set(limit_data)